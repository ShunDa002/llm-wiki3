...
allowed-tools: Read, Grep, Glob, Bash(bash scripts/wiki-lint.sh), Bash(bash scripts/check-schema.sh), Bash(bash scripts/find-duplicates.sh:*), Bash(bash scripts/lint-governance.sh), Bash(bash scripts/verify-vault.sh), Bash(git status:*)
---
